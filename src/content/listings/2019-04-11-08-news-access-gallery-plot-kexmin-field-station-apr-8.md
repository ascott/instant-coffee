...
type: ""
venue: "NEWS"
summary: "NEWS | Access Gallery | PLOT | K̲EXMIN Field Station | APR 8"
---
...
"with a wide range of heritages"engage fully around unceded land and sites, with 
respect and support towards the rapidly evolving cultural, political, and legal protocols of 
the xwmkwy"m (Musqueam), Skwxw7mesh (Squamish) and sl"lwta"/Selilwitulh 
(Tsleil-Waututh) nations? For Indigenous artists, what does it mean to have a heritage 
and political entitlement around unceded sites such as hole-in-bottom? Considering the 
seismically-vulnerable terrain of hole-in-bottom, how can site-based artistic interventions 
and permanent public artworks hold transformative roles within its redeveloping 
neighbourhoods, where new construction forges onwards despite its geological 
instability?
