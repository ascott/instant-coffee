...
number: 59
type: "EDUCATION"
summary: "VIVO Media Arts Centre | WORKSHOP | Sound Design | MAY 6"
---

Sound Design with Alexandre Klinke

Learn how to create richly textured audio elements with composer and sound
designer Alexandre Klinke (alexandreklinke.com), through sample manipulation,
...
music production. The course will be based on Ableton Live, a flexible and
sophisticated digital audio workstation, and powerful free plugin synthesizers
such as Synth1 and TyrellN6. Learn the basics of audio synthesis, sampling and
effects.
